                                                      ...
                                                      <table width="100%" cellspacing="0" cellpadding="0"
                                                          ...
                                                          <tr>
                                                              <td align="left" style="padding:0;Margin:0">
                                                                  <h1
                                                                      style="Margin:0;line-height:43px;mso-line-height-rule:exactly;font-family:Marcellus, Arial, serif;font-size:32px;font-style:normal;font-weight:normal;color:#026fe5">
                                                                      Vermel Hospice, Inc Confirmation</h1>
                                                              </td>
                                                          </tr>
                                                      </table>
                                                  </td>
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%"
                                              ...
                                              <tr>
                                                  <td align="center" valign="top"
                                                      style="padding:0;Margin:0;width:520px">
                                                      <table cellpadding="0" cellspacing="0" width="100%"
                                                          style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-left:2px solid #026fe5">
                                                          <tr>
