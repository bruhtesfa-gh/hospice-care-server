...
app.post("/appointment", (req: Request, res: Response) => {
                                                                    ...
                                                                    <td align="left" style="padding:0;Margin:0">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <strong>Email : </strong> <a href="mailto:${email}"
                                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:'Work Sans', Arial, sans-serif;color:#00356c;font-size:12px"
    ...
    `
        sendMail(req.body.name, process.env.MAIL, 'Confirmation of Your Appointment with Vermel Hospice, Inc', html);
    } catch (error: any) {
...
app.post("/contact-us", (req: Request, res: Response) => {
    ...
    `
        sendMail(name, process.env.MAIL, subject, html);
